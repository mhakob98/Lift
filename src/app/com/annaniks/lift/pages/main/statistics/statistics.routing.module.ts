...
let statisticsRoutes: Routes = [
    {
        path: '', component: StatisticsComponent, children: [
            ...
            {
                path: 'preview',
                loadChildren: () => import('src/app/com/annaniks/lift/pages/main/statistics/preview/preview.module')
                    .then(m => m.PreviewModule)
            },
            {
                path: 'subscribers',
                loadChildren: () => import('src/app/com/annaniks/lift/pages/main/statistics/subscribes-posts/subscribes-posts.module')
            ...
            {
                path: 'likes',
                loadChildren: () => import('src/app/com/annaniks/lift/pages/main/statistics/likes-comments-bookmarks/likes-comments-bookmarks.module')
